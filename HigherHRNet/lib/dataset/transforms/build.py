...
def build_transforms(cfg, is_train=True):
    ...
    if is_train:
        max_rotation = cfg.DATASET.MAX_ROTATION     # 最大旋转角度30
        min_scale = cfg.DATASET.MIN_SCALE    # 最小缩放比例0.75
        max_scale = cfg.DATASET.MAX_SCALE   # 最大缩放比例1.5
        max_translate = cfg.DATASET.MAX_TRANSLATE    # 最大转换40
        input_size = cfg.DATASET.INPUT_SIZE                # 输入大小512
        output_size = cfg.DATASET.OUTPUT_SIZE           # 输出128， 256
